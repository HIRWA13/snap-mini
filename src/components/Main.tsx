...
export default function Main():ReactElement {
  return (
    <main className="space-y-8 md:p-3 md:flex md:items-center md:justify-around md:w-4/5 md:mx-auto">
      <section className=" md:w-1/2 md:space-y-24">
        <section>
          <img src={mobileHero} className="md:hidden" />
        </section>
        <section className="mt-5 md:mt-0 flex flex-col items-center justify-center gap-3 md:items-start md:space-y-6 md:p-0">
          <h1 className="text-4xl text-dark text-center font-Epilogue font-black md:text-7xl md:text-left md:pr-32">
            Make remote work
          </h1>
          <p className="text-gray font-Epilogue text-center md:text-left md:text-xl md:px-0 md:pr-20">
